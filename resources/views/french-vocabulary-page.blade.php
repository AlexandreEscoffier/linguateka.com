...
<html>
<head>
    <title>French Vocabulary - Linguateka</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="{{ asset('css/style-french-vocabulary-page.css') }}">
    <link rel="icon" href="{{ asset('/others-images/linguateka-favicon.png') }}" type="image/png">
</head>
<body>
    <div class="linguateka-logo">
        <h1>French Special Vocabulary</h1>
    </div>

    <div class="expressions-content">
        <p>This page contain special French vocabulary who needs to be explain with their translations.</p>
