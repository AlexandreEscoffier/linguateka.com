...
<html>
<head>
    <title>Polish Expressions - Linguateka</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="{{ asset('css/style-polish-expressions-page.css') }}">
    <link rel="icon" href="{{ asset('/others-images/linguateka-favicon.png') }}" type="image/png">
</head>
<body>
    <div class="linguateka-logo">
        <h1>Polish Expressions</h1>
    </div>

    <div class="expressions-content">
        <p>This page contain Polish expressions with their translations, and illustratated with a image.</p>
