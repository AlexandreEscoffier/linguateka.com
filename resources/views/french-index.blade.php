...
<div class="top-controls-mobile">
    <div class="main-text-videos-mobile">
        ...
        <div class="combo-box-mobile">
            <a href="{{ route('index') }}" class="link-mobile compact-link">
                <img src="https://flagcdn.com/pl.svg" alt="PL">
                <div class=link-mobile-span><span>PL Version</span></div>
            </a>
            ...
            <div class="burger-wrapper-mobile">
                ...
                <div id="burger-mobile-content">
                    <a href="{{ route('french-vocabulary-road') }}">French Vocabulary</a>
                    <a href="{{ route('french-expressions-road') }}">French Expressions</a>
                    <a href="{{ route('index') }}">Polish Version</a>
                </div>
            </div>
        </div>
...
<div class="top-controls">
    ...
    <div class="combo-box">
        <a href="{{ route('index') }}" class="link-desktop compact-link">
            <img src="https://flagcdn.com/pl.svg" alt="PL">
...
<div class="card-container">
    ...
    <div class="card" id="video-{{ $video->name }}"
        data-french="{{ strtolower($video->polish_text) }}"
    ...
    >
        <a href="{{ url('/french-video/' . $video->name) }}">
            <img src="{{ asset('french-videos/french-videos-images/' . $video->name . '.jpg') }}" alt="{{ $video->name }}">
        </a>
